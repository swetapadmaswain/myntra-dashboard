...
class FrictionAnalyzer:
    ...
    FRICTION_TYPES = ['fit_sizing', 'styling_wardrobe', 'social_validation', 'visual_reality', 'price_value']
    FRICTION_COLORS = {
        'fit_sizing': '#ff3f6c',
    ...
    def calculate_friction_breakdown(
        ...
        """
        # Check cache first
        cache_key = f"friction_breakdown:segment_{segment_id}:time_{time_range}"
